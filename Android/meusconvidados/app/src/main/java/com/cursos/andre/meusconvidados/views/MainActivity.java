...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    private void startDefaultFragment() {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.frame_contect, fragment).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_present: {
                fragmentClass = PresentsFragment.class;
        ...
        fragmentManager.beginTransaction().replace(R.id.frame_contect, fragment).commit();

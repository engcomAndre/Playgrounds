...
public class Instructor extends ApplicationUser implements Serializable {
    ...
    public Instructor(String name, String cpf, TypeUser typeUser, Date bornDate, Date updatedDate,String password) {
